...
# part_size_here = 48 * 8
# block_size_here = 48
# reorg_idx = generate_reorg_indices(length_here, part_size_here, block_size_here)
# restore_idx = generate_restore_indices(length_here, part_size_here, block_size_here)
length_here = 80640
...
# latent_h = 48
# latent_w = 80
# part_size_here = latent_w * pool_h
# block_size_here = latent_w
# sub_block_size_here = pool_w
...
def flash_attention(
    ...
    streaming_info = None
    block_size = 128
    # seq_len_here = 32256    # 512p
    seq_len_here = 80640    # 768p
    cu_seqlens_q=torch.cat([q_lens.new_zeros([1]), q_lens]).cumsum(
        0, dtype=torch.int32).to(q.device, non_blocking=True)
    ...
    q_block_num = seq_len_here // block_size
    k_block_num = seq_len_here // block_size
