...
def parallel_attention(q, k, v, img_q_len, img_kv_len, cu_seqlens_q, cu_seqlens_kv, max_seqlen_q, max_seqlen_kv, time_step=None, layer_num=None):
    ...
    # Xuan:
    # 768x1280: 
    #   query.shape = [2, 130560, 3, 128]
    #   encoder_query.shape = [2, 831, 3, 128]
    ...
    # Xuan:
    # 720x1280: 
    #   query.shape = [246_462, 3, 128], img_q_len = 15300
    #   246_462 = 122_400 * 2 + 831, 831 is the text token length
    #   122_400 = 34*(45*80)

    # 768x1280: 
    #   query.shape = [262_782, 3, 128], img_q_len = 16320
    #   262_782 = (130_560 + 831) * 2, 831 is the text token length
    #   130_560 = 34*(48*80)
